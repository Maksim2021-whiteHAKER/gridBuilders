...
export function MobileTutorial({ onClose }: { onClose: () => void }) {
    ...
    const steps = [
        ...
        },
        {
            ...
            text: 'Открой меню камеры, и используй ползунки "Позиции" X Y Z и "Ориентации" X Y с левой стороны для вращения камеры и движения камеры. Просто двигайте ползунки пальцем в левой части экрана.',
            image: ''
        },
        {
            title: '🎯 Выбор объекта',
